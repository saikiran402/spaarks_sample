...
const newInfoStepperScreen2 = ({
  ...
  const showText = [
    'Spaark remains at this location, even if you open the app at a new location.',
    'Spaark Moves with you when ever you open the app'
  ]
  var radio_props = [
  ...
  var pin_props = [
    { label: "Pin Spaark at this location", value: 0 },
    { label: "Move post wherever I go", value: 1 },
  ]
  ...
  async function onSubmitSteps (){
    ...
    console.log('profilePic',route.params.isPicOn);
    console.log('name',route.params.isNameOn);
    ...
    // console.log("Market");
    var uservisibility = {
      name: String(route.params.isNameOn),
      profilePic: String(route.params.isPicOn),
      gender: "Male",
  ...
  return (
   ...
   <Text style={{color:'#fff',padding:10,justifyContent:'center',textAlign:'center'}} onPress={()=>{onSubmitSteps()}}>{ I18n.t("Post Spaark")}</Text>
      ...
      {/* <View style={{backgroundColor:'#6FA4E9',justifyContent:'center',textAlign:'center',margin:10,marginTop:0}} >
        <Text style={{color:'#fff',padding:10,justifyContent:'center',textAlign:'center'}} onPress={()=>{onSubmitSteps()}}>Post Spaark</Text>
      </View> */}
      </ScrollView>
    </SafeAreaView>
  );
