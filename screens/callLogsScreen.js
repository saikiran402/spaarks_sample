...
const callLogsScreen = ({navigation,route,token }) => {
                                  ...
                                  >
                                    ...
                                    <View style={{ flex: 30 }}>
                                        ...
                                        <View style={{ flexDirection: "column",padding:8,paddingTop:0 }}>
                                          ...
                                          <TouchableOpacity onPress={()=>navigation.navigate('DetailedCallLogs',{title:"Recents",name:item.uid.name,profilePic:item.uid.profilePic,aid:item.aid})}> 
                                          <Text
                                          ...
                                          >
                                              ...
                                              <>
                                                ...
                                                <Text>{I18n.t("Click to see logs")}</Text>
                                    ...
                                    <View style={{ flex: 8,flexDirection:'column' }}>
                                      ...
                                      >
                                          ...
                                          {/* {moment(item.createdAt).subtract(1, 'days').calendar()} */}
                                          {
...
export default connect(mapStatetoProps)(callLogsScreen);
