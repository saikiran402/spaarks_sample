...
//     setPosting(true)
//    console.log( route.params.pollOptions,route.params.pollQuestion)
...
//   }
  async function onSubmitSteps (){
    ...
    formData.append("pollQuestion", route.params.pollQuestion);

    // options.forEach(list=>{
    //   formData.append("pollOption[question]", list);
    // })
    formData.append("pollOption", JSON.stringify(route.params.pollOptions));
    formData.append("expiresIn", selectedLanguage );
  ...
  return (
    <SafeAreaView style={{ backgroundColor: "#f2f2f2",flex:1 }}>
      ...
      >
        ...
        > 
          <View style={{ flex: 1, padding: 0,height:150 }}>
        <Text style={{padding:5,fontSize:15,fontWeight:'700'}}>Poll Duration</Text>
                <Picker
  ...
  <Picker.Item label="24 Hrs" value="1" />
  ...
  <Picker.Item label="5 Days" value="5" />
    ...
    >
      ...
      {
    posting?
    <View style={{backgroundColor:'#A9A9A9',justifyContent:'center',textAlign:'center',margin:0,marginTop:0,position:'absolute',bottom:0,width:'100%'}} >
    <Text style={{color:'#fff',padding:10,justifyContent:'center',textAlign:'center'}}>Creating Spaark...</Text>
  </View>:
   <View style={{backgroundColor:'#6FA4E9',justifyContent:'center',textAlign:'center',margin:0,marginTop:0,position:'absolute',bottom:0,width:'100%'}} >
...
export default NewPollStepperScreen2;
